...
<div class="ctr-container ctr-mx-auto">
    ...
    <div class="ctr-grid md:ctr-grid-cols-4 lg:ctr-grid-cols-6 ctr-pl-8 ">
...
<div class="ctr-text-center ctr-mt-10">
    <a class="ctr-px-6 ctr-py-3 ctr-text-gray-100 ctr-no-underline ctr-bg-gray-500 ctr-rounded hover:ctr-bg-gray-600 hover:ctr-text-gray-200" href="<?php ctr_print_full_start_url(); ?>" class="ctr-bg-gray-300 ctr-hover:bg-gray-400 ctr-text-gray-800 ctr-font-bold ctr-py-2 ctr-px-4 ctr-rounded inline-flex ctr-items-center">
